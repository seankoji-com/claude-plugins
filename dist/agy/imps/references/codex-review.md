...
runtime from Claude Code's own `~/.gemini/config/plugins/installed_plugins.json` — the install
...
| `IMPS_CLAUDE_PLUGINS_MANIFEST` | `~/.gemini/config/plugins/installed_plugins.json` | Install manifest to query |
