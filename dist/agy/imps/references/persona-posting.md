...
`mm-sre`, `mm-business-analyst`, `mm-ux-designer`) via `~/.gemini/config/scripts/persona-post.sh`,
...
~/.gemini/config/scripts/persona-post.sh <slug> <owner/repo> pr-review <PR> "$f" <APPROVE|REQUEST_CHANGES|COMMENT>
```
