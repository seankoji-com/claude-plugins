...
own findings (below) are why: of its three *counted* passes, one (task 3) was
wrong on human diff review — and a second oracle-green result (task 4) was wrong
too, though it is already recorded as a fail in its own row. Five of the five
rows went oracle-green at some point; only two survive diff review. Diff review
is folded into the criterion itself,
